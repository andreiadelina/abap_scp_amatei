CLASS zcl_library_load_data_mateia DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_library_load_data_mateia IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA: lt_acc_categ    TYPE TABLE OF ztb_acc_categ_ma,
          lt_catego   TYPE TABLE OF ztb_catego_ma,
          lt_clientes     TYPE TABLE OF ztb_clientes_ma,
          lt_clnts_lib TYPE TABLE OF ztb_clnts_lib_ma,
          lt_libros       TYPE TABLE OF ztb_libros_ma.
...
******** ZTB_CATEGO_MA ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_catego_ma.
    insert ztb_catego_ma from table @lt_catego.
...
******** ZTB_CLIENTES_MA ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clientes_ma.
    insert ztb_clientes_ma from table @lt_clientes.
...
********ZTB_CLNTS_LIB_MA******
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clnts_lib_ma.
    insert ztb_clnts_lib_ma from table @lt_clnts_lib.
...
******** TABLA5 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_libros_ma.
    insert ztb_libros_ma from table @lt_libros.
